...
#===============================================================================================================
#...............................................................................................................
def vacants_antisemiradio_number(filename, number_new_atoms, output_file,x0,y0,radius,middle_radius,length):

    """This function generates vacancies inside a particular radius considering a specific number of Vacancies."""
    ...
    with open(filename, "r") as file:
        ...
        for line_number,line in enumerate(file):
			...
			# Reading atoms with a 1-probability. Note that is the same that delete atoms with a probability.
                ...
                inside.append(True)
                if((float(x)-x0)*(float(x)-x0)+(float(y)-y0)*(float(y)-y0) > (middle_radius+radius/2.0)*(middle_radius+radius/2.0)):
                	count_list.append(count-1)

                elif ((float(x)-x0)*(float(x)-x0)+(float(y)-y0)*(float(y)-y0) < (middle_radius-radius/2.0)*(middle_radius-radius/2.0)):
                    count_list.append(count-1)

    random_sample = random.sample(count_list,  int(number_new_atoms))
